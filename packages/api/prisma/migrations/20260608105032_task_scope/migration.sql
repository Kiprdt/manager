...
INSERT INTO "new_Task" ("actualMinutes", "categoryId", "completedAt", "createdAt", "description", "dueAllDay", "dueAt", "estimatedMinutes", "goalId", "id", "importance", "notes", "parentId", "priority", "recurrenceRule", "status", "tags", "title", "urgent") SELECT "actualMinutes", "categoryId", "completedAt", "createdAt", "description", "dueAllDay", "dueAt", "estimatedMinutes", "goalId", "id", "importance", "notes", "parentId", "priority", "recurrenceRule", "status", "tags", "title", "urgent" FROM "Task";
DROP TABLE "Task";
